...
export const goalPeriod = pgEnum('goal_period', [
  'monthly',
  'quarterly',
  'yearly',
]);
...
export const gratitudeStatus = pgEnum('gratitude_status', [
  'planned',
  'scheduled',
  'sent',
  'delivered',
...
export const gratitudeType = pgEnum('gratitude_type', [
  'thank_you_call',
  'thank_you_message',
  'gift_delivery',
  'meal_invitation',
...
export const influencerTier = pgEnum('influencer_tier', [
  'bronze',
  'silver',
  'gold',
  'platinum',
...
export const metricPeriod = pgEnum('metric_period', [
  'daily',
  'weekly',
  'monthly',
  'quarterly',
...
export const networkAnalysisType = pgEnum('network_analysis_type', [
  'centrality',
  'clustering',
  'path_analysis',
  'influence_mapping',
...
export const networkNodeType = pgEnum('network_node_type', [
  'client',
  'prospect',
  'influencer',
  'partner',
...
export const pipelineViewType = pgEnum('pipeline_view_type', [
  'kanban',
  'list',
  'table',
  'timeline',
...
export const stageActionType = pgEnum('stage_action_type', [
  'moved_to_stage',
  'stage_created',
  'stage_updated',
  'stage_deleted',
...
export const teamEventType = pgEnum('team_event_type', [
  'member_joined',
  'member_left',
  'member_promoted',
  'member_demoted',
...
export const insuranceInfo = pgTable(
  'insurance_info',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    clientId: uuid('client_id').notNull(),
...
export const clientAnalytics = pgTable(
  'client_analytics',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    clientId: uuid('client_id').notNull(),
    ...
    referralValue: numeric('referral_value', {
      precision: 12,
      scale: 2,
    }).default('0'),
...
export const clientContactHistory = pgTable(
...
export const clientPreferences = pgTable(
  'client_preferences',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    clientId: uuid('client_id').notNull(),
    preferredContactMethod: contactMethod('preferred_contact_method').default(
      'phone'
    ),
...
export const gratitudeHistory = pgTable(
  'gratitude_history',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const gratitudeTemplates = pgTable(
  'gratitude_templates',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    agentId: uuid('agent_id').notNull(),
...
export const networkAnalysis = pgTable(
  'network_analysis',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    agentId: uuid('agent_id').notNull(),
...
export const referralPatterns = pgTable(
  'referral_patterns',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    influencerId: uuid('influencer_id').notNull(),
...
export const invitationAnalytics = pgTable(
...
export const invitationCampaigns = pgTable(
...
export const invitationTemplates = pgTable(
...
export const invitationRewards = pgTable(
  'invitation_rewards',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    inviterId: uuid('inviter_id').notNull(),
...
export const invitationUsageLogs = pgTable(
...
export const invitationWaitlist = pgTable(
  'invitation_waitlist',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    email: text().notNull(),
...
export const networkAnalysisResults = pgTable(
...
export const networkInteractions = pgTable(
...
export const networkOpportunities = pgTable(
...
export const pipelineAnalytics = pgTable(
  'pipeline_analytics',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    userId: uuid('user_id').notNull(),
    ...
    averageValue: numeric('average_value', { precision: 12, scale: 2 }).default(
      '0'
    ),
    createdAt: timestamp('created_at', { withTimezone: true, mode: 'string' })
      .defaultNow()
...
export const pipelineAutomations = pgTable(
...
export const pipelineBottlenecks = pgTable(
...
export const pipelineGoals = pgTable(
  'pipeline_goals',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    userId: uuid('user_id').notNull(),
...
export const pipelineViews = pgTable(
  'pipeline_views',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    userId: uuid('user_id').notNull(),
...
export const backupConfigurations = pgTable(
...
export const teamAnnouncements = pgTable(
  'team_announcements',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    teamId: uuid('team_id').notNull(),
...
export const teamCollaborations = pgTable(
  'team_collaborations',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    teamId: uuid('team_id').notNull(),
...
export const teamKnowledgeBase = pgTable(
  'team_knowledge_base',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    teamId: uuid('team_id').notNull(),
...
export const teamPerformance = pgTable(
  'team_performance',
  {
    ...
    totalRevenue: numeric('total_revenue', { precision: 15, scale: 2 })
      .default('0')
      .notNull(),
    averageRevenue: numeric('average_revenue', { precision: 12, scale: 2 })
      .default('0')
      .notNull(),
    conversionRate: numeric('conversion_rate', { precision: 5, scale: 2 })
      .default('0')
...
export const meetingChecklists = pgTable(
  'meeting_checklists',
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    meetingId: uuid('meeting_id').notNull(),
