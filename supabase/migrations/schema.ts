import { pgTable, uuid, text, jsonb, timestamp, unique, boolean, foreignKey, integer, numeric, date, pgPolicy, pgEnum } from "drizzle-orm/pg-core"
import { sql } from "drizzle-orm"

export const appCalendarExternalSourceEnum = pgEnum("app_calendar_external_source_enum", ['local', 'google_calendar', 'outlook', 'apple_calendar'])
export const appCalendarMeetingStatusEnum = pgEnum("app_calendar_meeting_status_enum", ['scheduled', 'completed', 'cancelled', 'rescheduled'])
export const appCalendarMeetingTypeEnum = pgEnum("app_calendar_meeting_type_enum", ['first_consultation', 'product_explanation', 'contract_review', 'follow_up', 'other'])
export const appCalendarRecurrenceTypeEnum = pgEnum("app_calendar_recurrence_type_enum", ['none', 'daily', 'weekly', 'monthly', 'yearly'])
export const appCalendarReminderTypeEnum = pgEnum("app_calendar_reminder_type_enum", ['none', '5_minutes', '15_minutes', '30_minutes', '1_hour', '1_day'])
export const appCalendarSyncStatusEnum = pgEnum("app_calendar_sync_status_enum", ['not_synced', 'syncing', 'synced', 'sync_failed', 'sync_conflict'])
export const appCalendarViewEnum = pgEnum("app_calendar_view_enum", ['month', 'week', 'day', 'agenda'])
export const appChartTypeEnum = pgEnum("app_chart_type_enum", ['line', 'bar', 'pie', 'doughnut', 'area', 'scatter', 'funnel', 'gauge'])
export const appClientContactMethodEnum = pgEnum("app_client_contact_method_enum", ['phone', 'email', 'kakao', 'sms', 'in_person', 'video_call'])
export const appClientDataAccessLogTypeEnum = pgEnum("app_client_data_access_log_type_enum", ['view', 'edit', 'export', 'share', 'delete'])
export const appClientPrivacyLevelEnum = pgEnum("app_client_privacy_level_enum", ['public', 'restricted', 'private', 'confidential'])
export const appClientSourceEnum = pgEnum("app_client_source_enum", ['referral', 'cold_call', 'marketing', 'website', 'social_media', 'event', 'partner', 'other'])
export const appClientStatusEnum = pgEnum("app_client_status_enum", ['prospect', 'contacted', 'qualified', 'proposal_sent', 'negotiating', 'closed_won', 'closed_lost', 'dormant'])
export const appContractDocumentTypeEnum = pgEnum("app_contract_document_type_enum", ['contract', 'policy', 'application', 'identification', 'medical_report', 'vehicle_registration', 'other_document'])
export const appContractStatusEnum = pgEnum("app_contract_status_enum", ['draft', 'active', 'cancelled', 'expired', 'suspended'])
export const appDashboardActivityTypeEnum = pgEnum("app_dashboard_activity_type_enum", ['client_added', 'client_updated', 'meeting_scheduled', 'meeting_completed', 'meeting_cancelled', 'referral_received', 'referral_converted', 'goal_achieved', 'stage_changed', 'document_uploaded', 'insurance_added'])
export const appDashboardGoalPeriodEnum = pgEnum("app_dashboard_goal_period_enum", ['monthly', 'quarterly', 'yearly'])
export const appDashboardGoalTypeEnum = pgEnum("app_dashboard_goal_type_enum", ['clients', 'meetings', 'revenue', 'referrals', 'conversion_rate'])
export const appDashboardMetricPeriodEnum = pgEnum("app_dashboard_metric_period_enum", ['daily', 'weekly', 'monthly', 'quarterly', 'yearly'])
export const appDashboardNotificationPriorityEnum = pgEnum("app_dashboard_notification_priority_enum", ['low', 'normal', 'high', 'urgent'])
export const appDashboardNotificationTypeEnum = pgEnum("app_dashboard_notification_type_enum", ['meeting_reminder', 'goal_achievement', 'goal_deadline', 'new_referral', 'client_milestone', 'team_update', 'system_alert'])
export const appDashboardWidgetTypeEnum = pgEnum("app_dashboard_widget_type_enum", ['kpi_card', 'chart', 'table', 'calendar', 'list', 'progress', 'notification', 'quick_action'])
export const appDocumentTypeEnum = pgEnum("app_document_type_enum", ['policy', 'id_card', 'vehicle_registration', 'vehicle_photo', 'dashboard_photo', 'license_plate_photo', 'blackbox_photo', 'insurance_policy_photo', 'other'])
export const appGenderEnum = pgEnum("app_gender_enum", ['male', 'female'])
export const appImportanceEnum = pgEnum("app_importance_enum", ['high', 'medium', 'low'])
export const appInfluencerActivityTypeEnum = pgEnum("app_influencer_activity_type_enum", ['new_referral', 'referral_converted', 'gratitude_sent', 'meeting_scheduled', 'tier_upgraded', 'network_expanded', 'relationship_strengthened'])
export const appInfluencerContactMethodEnum = pgEnum("app_influencer_contact_method_enum", ['phone', 'email', 'kakao', 'sms', 'in_person', 'video_call', 'letter'])
export const appInfluencerDataSourceEnum = pgEnum("app_influencer_data_source_enum", ['direct_input', 'auto_calculated', 'imported', 'api_sync'])
export const appInfluencerGiftTypeEnum = pgEnum("app_influencer_gift_type_enum", ['flowers', 'food_voucher', 'coffee_voucher', 'traditional_gift', 'cash_gift', 'experience_voucher', 'custom_gift', 'none'])
export const appInfluencerGratitudeStatusEnum = pgEnum("app_influencer_gratitude_status_enum", ['planned', 'scheduled', 'sent', 'delivered', 'completed', 'cancelled', 'failed'])
export const appInfluencerGratitudeTypeEnum = pgEnum("app_influencer_gratitude_type_enum", ['thank_you_call', 'thank_you_message', 'gift_delivery', 'meal_invitation', 'event_invitation', 'holiday_greetings', 'birthday_wishes', 'custom'])
export const appInfluencerTierEnum = pgEnum("app_influencer_tier_enum", ['bronze', 'silver', 'gold', 'platinum', 'diamond'])
export const appInsuranceTypeEnum = pgEnum("app_insurance_type_enum", ['life', 'health', 'auto', 'prenatal', 'property', 'other'])
export const appInvitationStatusEnum = pgEnum("app_invitation_status_enum", ['pending', 'used', 'expired', 'cancelled'])
export const appMeetingStatusEnum = pgEnum("app_meeting_status_enum", ['scheduled', 'completed', 'cancelled', 'rescheduled'])
export const appMeetingTypeEnum = pgEnum("app_meeting_type_enum", ['first_consultation', 'product_explanation', 'contract_review', 'follow_up', 'other'])
export const appNetworkAnalysisTypeEnum = pgEnum("app_network_analysis_type_enum", ['centrality', 'clustering', 'path_analysis', 'influence_mapping', 'growth_tracking'])
export const appNetworkConnectionTypeEnum = pgEnum("app_network_connection_type_enum", ['direct_referral', 'family_member', 'colleague', 'friend', 'business_partner', 'community_member'])
export const appNetworkNodeTypeEnum = pgEnum("app_network_node_type_enum", ['client', 'prospect', 'influencer', 'partner', 'external'])
export const appNotificationChannelEnum = pgEnum("app_notification_channel_enum", ['in_app', 'email', 'sms', 'push', 'kakao'])
export const appNotificationPriorityEnum = pgEnum("app_notification_priority_enum", ['low', 'normal', 'high', 'urgent'])
export const appNotificationStatusEnum = pgEnum("app_notification_status_enum", ['pending', 'sent', 'delivered', 'read', 'failed', 'cancelled'])
export const appNotificationTypeEnum = pgEnum("app_notification_type_enum", ['meeting_reminder', 'goal_achievement', 'goal_deadline', 'new_referral', 'client_milestone', 'team_update', 'system_alert', 'birthday_reminder', 'follow_up_reminder', 'contract_expiry', 'payment_due'])
export const appPipelineAutomationActionEnum = pgEnum("app_pipeline_automation_action_enum", ['send_notification', 'create_task', 'schedule_meeting', 'move_to_stage', 'assign_to_user', 'send_email'])
export const appPipelineAutomationTriggerEnum = pgEnum("app_pipeline_automation_trigger_enum", ['stage_entry', 'stage_exit', 'time_in_stage', 'client_created', 'meeting_scheduled', 'document_uploaded'])
export const appPipelineStageActionTypeEnum = pgEnum("app_pipeline_stage_action_type_enum", ['moved_to_stage', 'stage_created', 'stage_updated', 'stage_deleted', 'bulk_move', 'automation_triggered'])
export const appPipelineViewTypeEnum = pgEnum("app_pipeline_view_type_enum", ['kanban', 'list', 'table', 'timeline', 'funnel'])
export const appReferralStatusEnum = pgEnum("app_referral_status_enum", ['active', 'inactive'])
export const appReportFormatEnum = pgEnum("app_report_format_enum", ['pdf', 'excel', 'csv', 'json', 'html'])
export const appReportFrequencyEnum = pgEnum("app_report_frequency_enum", ['daily', 'weekly', 'monthly', 'quarterly', 'yearly', 'on_demand'])
export const appReportStatusEnum = pgEnum("app_report_status_enum", ['pending', 'generating', 'completed', 'failed', 'cancelled'])
export const appReportTypeEnum = pgEnum("app_report_type_enum", ['performance', 'pipeline', 'client_analysis', 'referral_analysis', 'meeting_analysis', 'revenue', 'conversion', 'activity', 'custom'])
export const appSettingsCategory = pgEnum("app_settings_category", ['profile', 'notifications', 'system', 'security', 'integrations'])
export const appSettingsIntegrationStatus = pgEnum("app_settings_integration_status", ['active', 'inactive', 'error', 'pending'])
export const appSettingsIntegrationType = pgEnum("app_settings_integration_type", ['kakao_talk', 'google_calendar', 'email', 'sms'])
export const appSettingsNotificationChannel = pgEnum("app_settings_notification_channel", ['email', 'sms', 'push', 'kakao'])
export const appTeamActivityTypeEnum = pgEnum("app_team_activity_type_enum", ['member_joined', 'member_left', 'member_promoted', 'member_demoted', 'goal_created', 'goal_achieved', 'meeting_scheduled', 'performance_milestone'])
export const appTeamMemberRoleEnum = pgEnum("app_team_member_role_enum", ['member', 'manager', 'admin'])
export const appTeamMemberStatusEnum = pgEnum("app_team_member_status_enum", ['active', 'inactive', 'pending'])
export const appThemeEnum = pgEnum("app_theme_enum", ['light', 'dark'])
export const appUserRoleEnum = pgEnum("app_user_role_enum", ['agent', 'team_admin', 'system_admin'])
...
export const publicContentStatusEnum = pgEnum("public_content_status_enum", ['draft', 'published', 'archived'])
export const publicContentTypeEnum = pgEnum("public_content_type_enum", ['terms_of_service', 'privacy_policy', 'faq', 'announcement', 'help_article'])
export const publicLanguageEnum = pgEnum("public_language_enum", ['ko', 'en', 'ja', 'zh'])
...
export const appClientDocuments = pgTable("app_client_documents", {
	id: uuid().defaultRandom().primaryKey().notNull(),
...
export const appPipelineStageTemplates = pgTable("app_pipeline_stage_templates", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: uuid("user_id"),
	teamId: uuid("team_id"),
	name: text().notNull(),
...
export const appClientInsuranceContracts = pgTable("app_client_insurance_contracts", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	clientId: uuid("client_id").notNull(),
	agentId: uuid("agent_id").notNull(),
...
export const appClientContractAttachments = pgTable("app_client_contract_attachments", {
	id: uuid().defaultRandom().primaryKey().notNull(),
...
export const appClientMeetings = pgTable("app_client_meetings", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	clientId: uuid("client_id").notNull(),
	agentId: uuid("agent_id").notNull(),
	title: text().notNull(),
...
export const appClientReferrals = pgTable("app_client_referrals", {
	id: uuid().defaultRandom().primaryKey().notNull(),
...
export const appClientInsurance = pgTable("app_client_insurance", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	clientId: uuid("client_id").notNull(),
	insuranceType: appInsuranceTypeEnum("insurance_type").notNull(),
	policyNumber: text("policy_number"),
...
export const appClientDetails = pgTable("app_client_details", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	clientId: uuid("client_id").notNull(),
	ssn: text(),
	...
	pgPolicy("Users can delete own client details", { as: "permissive", for: "delete", to: ["public"], using: sql`(client_id IN ( SELECT app_client_profiles.id
   FROM app_client_profiles
  WHERE (app_client_profiles.agent_id = auth.uid())))` }),
	pgPolicy("Users can insert own client details", { as: "permissive", for: "insert", to: ["public"] }),
	pgPolicy("Users can update own client details", { as: "permissive", for: "update", to: ["public"] }),
	pgPolicy("Users can view own client details", { as: "permissive", for: "select", to: ["public"] }),
]);

export const appOpportunityProducts = pgTable("app_opportunity_products", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	clientId: uuid("client_id").notNull(),
	agentId: uuid("agent_id").notNull(),
	productName: text("product_name").notNull(),
...
export const appCalendarMeetingAttendees = pgTable("app_calendar_meeting_attendees", {
	id: uuid().defaultRandom().primaryKey().notNull(),
...
export const appCalendarMeetingChecklists = pgTable("app_calendar_meeting_checklists", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	meetingId: uuid("meeting_id").notNull(),
	text: text().notNull(),
...
export const appCalendarMeetingReminders = pgTable("app_calendar_meeting_reminders", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	meetingId: uuid("meeting_id").notNull(),
...
export const appCalendarRecurringMeetings = pgTable("app_calendar_recurring_meetings", {
	id: uuid().defaultRandom().primaryKey().notNull(),
...
export const appInfluencerGratitudeHistory = pgTable("app_influencer_gratitude_history", {
	id: uuid().defaultRandom().primaryKey().notNull(),
...
export const appClientProfiles = pgTable("app_client_profiles", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	agentId: uuid("agent_id").notNull(),
	teamId: uuid("team_id"),
...
export const appUserInvitations = pgTable("app_user_invitations", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	code: text().notNull(),
...
export const appPipelineStages = pgTable("app_pipeline_stages", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	agentId: uuid("agent_id"),
	teamId: uuid("team_id"),
	name: text().notNull(),
...
export const appClientContactHistory = pgTable("app_client_contact_history", {
	...
	attachments: jsonb(),
	privacyLevel: appClientPrivacyLevelEnum("privacy_level").default('restricted').notNull(),
...
export const appClientFamilyMembers = pgTable("app_client_family_members", {
	...
	notes: text(),
	privacyLevel: appClientPrivacyLevelEnum("privacy_level").default('confidential').notNull(),
	consentDate: timestamp("consent_date", { withTimezone: true, mode: 'string' }),
	consentExpiry: timestamp("consent_expiry", { withTimezone: true, mode: 'string' }),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
	foreignKey({
...
export const appClientPreferences = pgTable("app_client_preferences", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	clientId: uuid("client_id").notNull(),
	preferredContactMethod: appClientContactMethodEnum("preferred_contact_method").default('phone'),
	...
	thirdPartyShareConsent: boolean("third_party_share_consent").default(false).notNull(),
	privacyLevel: appClientPrivacyLevelEnum("privacy_level").default('private').notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
	foreignKey({
...
export const appInfluencerProfiles = pgTable("app_influencer_profiles", {
	...
	averageContractValue: numeric("average_contract_value", { precision: 12, scale:  2 }).default('0').notNull(),
	...
	preferredContactMethod: appInfluencerContactMethodEnum("preferred_contact_method"),
	specialNotes: text("special_notes"),
	isActive: boolean("is_active").default(true).notNull(),
	dataSource: appInfluencerDataSourceEnum("data_source").default('auto_calculated').notNull(),
...
export const appClientCheckupPurposes = pgTable("app_client_checkup_purposes", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	clientId: uuid("client_id").notNull(),
	isInsurancePremiumConcern: boolean("is_insurance_premium_concern").default(false).notNull(),
	isCoverageConcern: boolean("is_coverage_concern").default(false).notNull(),
	isMedicalHistoryConcern: boolean("is_medical_history_concern").default(false).notNull(),
	...
	needsCaregiverInsurance: boolean("needs_caregiver_insurance").default(false).notNull(),
	needsDementiaInsurance: boolean("needs_dementia_insurance").default(false).notNull(),
...
export const appClientConsultationCompanions = pgTable("app_client_consultation_companions", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	clientId: uuid("client_id").notNull(),
	name: text().notNull(),
	phone: text().notNull(),
...
export const appClientConsultationNotes = pgTable("app_client_consultation_notes", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	clientId: uuid("client_id").notNull(),
	agentId: uuid("agent_id").notNull(),
...
export const appClientInterestCategories = pgTable("app_client_interest_categories", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	clientId: uuid("client_id").notNull(),
	interestedInAutoInsurance: boolean("interested_in_auto_insurance").default(false).notNull(),
	interestedInDementia: boolean("interested_in_dementia").default(false).notNull(),
	interestedInDental: boolean("interested_in_dental").default(false).notNull(),
	interestedInDriverInsurance: boolean("interested_in_driver_insurance").default(false).notNull(),
	interestedInHealthCheckup: boolean("interested_in_health_checkup").default(false).notNull(),
	interestedInMedicalExpenses: boolean("interested_in_medical_expenses").default(false).notNull(),
	interestedInFireInsurance: boolean("interested_in_fire_insurance").default(false).notNull(),
	interestedInCaregiver: boolean("interested_in_caregiver").default(false).notNull(),
	interestedInCancer: boolean("interested_in_cancer").default(false).notNull(),
	interestedInSavings: boolean("interested_in_savings").default(false).notNull(),
	interestedInLiability: boolean("interested_in_liability").default(false).notNull(),
	interestedInLegalAdvice: boolean("interested_in_legal_advice").default(false).notNull(),
	interestedInTax: boolean("interested_in_tax").default(false).notNull(),
	interestedInInvestment: boolean("interested_in_investment").default(false).notNull(),
	interestedInPetInsurance: boolean("interested_in_pet_insurance").default(false).notNull(),
	interestedInAccidentInsurance: boolean("interested_in_accident_insurance").default(false).notNull(),
	interestedInTrafficAccident: boolean("interested_in_traffic_accident").default(false).notNull(),
	...
	unique("app_client_interest_categories_client_id_unique").on(table.clientId),
]);

export const appClientMedicalHistory = pgTable("app_client_medical_history", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	clientId: uuid("client_id").notNull(),
	hasRecentDiagnosis: boolean("has_recent_diagnosis").default(false).notNull(),
	hasRecentSuspicion: boolean("has_recent_suspicion").default(false).notNull(),
	hasRecentMedication: boolean("has_recent_medication").default(false).notNull(),
	hasRecentTreatment: boolean("has_recent_treatment").default(false).notNull(),
	hasRecentHospitalization: boolean("has_recent_hospitalization").default(false).notNull(),
	...
	hasMajorHospitalization: boolean("has_major_hospitalization").default(false).notNull(),
	hasMajorSurgery: boolean("has_major_surgery").default(false).notNull(),
	hasLongTermTreatment: boolean("has_long_term_treatment").default(false).notNull(),
	hasLongTermMedication: boolean("has_long_term_medication").default(false).notNull(),
...
export const appInfluencerActivityLogs = pgTable("app_influencer_activity_logs", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	influencerId: uuid("influencer_id").notNull(),
	agentId: uuid("agent_id").notNull(),
...
export const appUserProfiles = pgTable("app_user_profiles", {
	...
	foreignKey({
			...
			name: "app_user_profiles_id_users_id_fk"
		}).onDelete("cascade"),
]);

export const appUserTeams = pgTable("app_user_teams", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	name: text().notNull(),
	description: text(),
	adminId: uuid("admin_id").notNull(),
...
export const publicSiteAnnouncements = pgTable("public_site_announcements", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	title: text().notNull(),
	content: text().notNull(),
...
export const publicSiteFaqs = pgTable("public_site_faqs", {
	id: uuid().defaultRandom().primaryKey().notNull(),
...
export const publicSiteAnalytics = pgTable("public_site_analytics", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	path: text().notNull(),
	userAgent: text("user_agent"),
	ipAddress: text("ip_address"),
...
export const publicSiteContents = pgTable("public_site_contents", {
	id: uuid().defaultRandom().primaryKey().notNull(),
...
export const publicSiteTestimonials = pgTable("public_site_testimonials", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	name: text().notNull(),
	role: text().notNull(),
...
export const appCalendarMeetingTemplates = pgTable("app_calendar_meeting_templates", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	agentId: uuid("agent_id").notNull(),
	name: text().notNull(),
	description: text(),
...
export const appCalendarSettings = pgTable("app_calendar_settings", {
	...
	defaultReminder: appCalendarReminderTypeEnum("default_reminder").default('30_minutes').notNull(),
	googleCalendarId: text("google_calendar_id"),
	googleAccessToken: text("google_access_token"),
	googleRefreshToken: text("google_refresh_token"),
	googleTokenExpiresAt: timestamp("google_token_expires_at", { withTimezone: true, mode: 'string' }),
	lastSyncAt: timestamp("last_sync_at", { withTimezone: true, mode: 'string' }),
	syncStatus: appCalendarSyncStatusEnum("sync_status").default('not_synced').notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
	foreignKey({
...
export const appClientTags = pgTable("app_client_tags", {
	...
	description: text(),
	isActive: boolean("is_active").default(true).notNull(),
	privacyLevel: appClientPrivacyLevelEnum("privacy_level").default('public').notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
	foreignKey({
...
export const appDashboardNotifications = pgTable("app_dashboard_notifications", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: uuid("user_id").notNull(),
	title: text().notNull(),
	message: text().notNull(),
	type: appDashboardNotificationTypeEnum().notNull(),
	priority: appDashboardNotificationPriorityEnum().default('normal').notNull(),
...
export const appDashboardPerformanceMetrics = pgTable("app_dashboard_performance_metrics", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	agentId: uuid("agent_id").notNull(),
	teamId: uuid("team_id"),
	date: date().notNull(),
...
export const appDashboardWidgets = pgTable("app_dashboard_widgets", {
	...
	lastRefreshed: timestamp("last_refreshed", { withTimezone: true, mode: 'string' }),
	order: integer().default(0).notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
...
export const appInfluencerGratitudeTemplates = pgTable("app_influencer_gratitude_templates", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	agentId: uuid("agent_id").notNull(),
	name: text().notNull(),
	gratitudeType: appInfluencerGratitudeTypeEnum("gratitude_type").notNull(),
...
export const appInfluencerNetworkAnalysis = pgTable("app_influencer_network_analysis", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	agentId: uuid("agent_id").notNull(),
	teamId: uuid("team_id"),
	...
	averageRelationshipStrength: numeric("average_relationship_strength", { precision: 3, scale:  2 }).default('0').notNull(),
	totalGratitudesSent: integer("total_gratitudes_sent").default(0).notNull(),
	averageGratitudeFrequency: numeric("average_gratitude_frequency", { precision: 5, scale:  2 }).default('0').notNull(),
	calculationVersion: text("calculation_version").default('1.0').notNull(),
	dataQualityScore: numeric("data_quality_score", { precision: 3, scale:  2 }).default('0').notNull(),
	missingDataFields: text("missing_data_fields").array(),
	confidenceLevel: numeric("confidence_level", { precision: 3, scale:  2 }).default('0').notNull(),
	calculatedAt: timestamp("calculated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	expiresAt: timestamp("expires_at", { withTimezone: true, mode: 'string' }).notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
...
export const appNotificationSubscriptions = pgTable("app_notification_subscriptions", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: uuid("user_id").notNull(),
...
export const appReportDashboards = pgTable("app_report_dashboards", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: uuid("user_id").notNull(),
	teamId: uuid("team_id"),
	name: text().notNull(),
...
export const appReportExports = pgTable("app_report_exports", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: uuid("user_id").notNull(),
...
export const appReportInstances = pgTable("app_report_instances", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: uuid("user_id").notNull(),
	templateId: uuid("template_id"),
...
export const appReportMetrics = pgTable("app_report_metrics", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: uuid("user_id").notNull(),
	teamId: uuid("team_id"),
	date: date().notNull(),
...
export const appReportSchedules = pgTable("app_report_schedules", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: uuid("user_id").notNull(),
	teamId: uuid("team_id"),
...
export const appReportSubscriptions = pgTable("app_report_subscriptions", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: uuid("user_id").notNull(),
	templateId: uuid("template_id").notNull(),
	email: text().notNull(),
...
export const appReportTemplates = pgTable("app_report_templates", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: uuid("user_id"),
	teamId: uuid("team_id"),
	name: text().notNull(),
...
export const appSettingsThemePreferences = pgTable("app_settings_theme_preferences", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	userId: uuid("user_id").notNull(),
...
export const appSettingsUserProfiles = pgTable("app_settings_user_profiles", {
	...
	notificationSettings: jsonb("notification_settings").default({"teamUpdates":true,"newReferrals":true,"systemAlerts":true,"goalDeadlines":true,"quietHoursEnd":"08:00","quietHoursStart":"22:00","clientMilestones":true,"meetingReminders":true,"smsNotifications":false,"birthdayReminders":false,"followUpReminders":true,"pushNotifications":true,"emailNotifications":true,"kakaoNotifications":true,"weekendNotifications":false}).notNull(),
	agentSettings: jsonb("agent_settings").default({"workingHours":{"end":"18:00","start":"09:00","workDays":[1,2,3,4,5]},"clientManagement":{"autoFollowUpDays":7,"birthdayReminderDays":3,"contractRenewalReminderDays":30},"performanceTracking":{"monthlyGoalReminder":true,"weeklyReportGeneration":true,"achievementNotifications":true}}),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
	foreignKey({
...
export const appTeamCommunicationChannels = pgTable("app_team_communication_channels", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	teamId: uuid("team_id").notNull(),
...
export const appTeamPerformanceMetrics = pgTable("app_team_performance_metrics", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	teamId: uuid("team_id").notNull(),
	...
	totalPremium: numeric("total_premium", { precision: 15, scale:  2 }).default('0').notNull(),
...
export const adminSystemSettings = pgTable("admin_system_settings", {
	...
	unique("admin_system_settings_key_unique").on(table.key),
]);

export const adminSystemStatsCache = pgTable("admin_system_stats_cache", {
	id: uuid().defaultRandom().primaryKey().notNull(),
