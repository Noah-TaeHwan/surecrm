...
import {
  ...
  appPipelineViews,
  appClientInsuranceContracts,
  appOpportunityProducts,
  appClientContractAttachments,
  appClientMeetings,
  appClientReferrals,
  appClientDetails,
...
export const appUserProfilesRelations = relations(
  ...
  ({ one, many }) => ({
    ...
    // 🔧 usersInAuth 관계 제거 - Supabase auth.users는 RLS로 관리됨
...
export const appClientInsuranceContractsRelations = relations(
  appClientInsuranceContracts,
  ({ one, many }) => ({
    appUserProfile: one(appUserProfiles, {
...
export const appOpportunityProductsRelations = relations(
  appOpportunityProducts,
  ({ one, many }) => ({
    appClientInsuranceContracts: many(appClientInsuranceContracts),
    appUserProfile: one(appUserProfiles, {
...
export const appClientContractAttachmentsRelations = relations(
  appClientContractAttachments,
  ({ one }) => ({
    appUserProfile: one(appUserProfiles, {
...
// 🔧 usersInAuth 관계 제거됨 - Supabase auth.users는 RLS로 관리
