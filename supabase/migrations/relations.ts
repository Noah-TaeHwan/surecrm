...
import { appUserProfiles, appClientDocuments, appClientProfiles, appClientInsurance, appPipelineStages, appPipelineAutomations, appUserTeams, appPipelineGoals, appPipelineStageHistory, appPipelineStageTemplates, appPipelineViews, appClientInsuranceContracts, appOpportunityProducts, appClientContractAttachments, appClientMeetings, appClientReferrals, appClientDetails, appCalendarMeetingAttendees, appCalendarMeetingChecklists, appCalendarMeetingNotes, appCalendarMeetingReminders, appCalendarRecurringMeetings, appCalendarSyncLogs, appInfluencerGratitudeHistory, appInfluencerProfiles, appUserInvitations, appClientAnalytics, appClientContactHistory, appClientDataAccessLogs, appClientDataBackups, appClientFamilyMembers, appClientMilestones, appClientPreferences, appClientStageHistory, appClientTagAssignments, appClientTags, appInvitationUsageLogs, appNetworkNodes, appPipelineAnalytics, appClientCheckupPurposes, appClientConsultationCompanions, appClientConsultationNotes, appClientInterestCategories, appClientMedicalHistory, appInfluencerActivityLogs, appNetworkEdges, appNetworkOpportunities, appNetworkInteractions, usersInAuth, publicSiteAnnouncements, publicSiteFaqs, publicSiteAnalytics, publicSiteContents, publicSiteSettings, publicSiteTestimonials, appCalendarMeetingTemplates, appCalendarSettings, appDashboardActivityLogs, appDashboardGoals, appDashboardNotifications, appDashboardPerformanceMetrics, appDashboardQuickActions, appDashboardWidgets, appInfluencerGratitudeTemplates, appInfluencerNetworkAnalysis, appNetworkStats, appNotificationQueue, appNotificationHistory, appNotificationTemplates, appNotificationRules, appNotificationSettings, appNotificationSubscriptions, appReportDashboards, appReportInstances, appReportExports, appReportSchedules, appReportTemplates, appReportMetrics, appReportSubscriptions, appSettingsBackups, appSettingsChangeLogs, appSettingsIntegrations, appSettingsSecurityLogs, appSettingsThemePreferences, appSettingsUserProfiles, appTeamActivityLogs, appTeamCommunicationChannels, appTeamGoals, appTeamMembers, appTeamPerformanceMetrics, appTeamStatsCache, appTeamTrainingRecords } from "./schema";

export const appClientDocumentsRelations = relations(appClientDocuments, ({one}) => ({
...
export const appUserProfilesRelations = relations(appUserProfiles, ({one, many}) => ({
	...
	appClientInsuranceContracts: many(appClientInsuranceContracts),
	appClientContractAttachments: many(appClientContractAttachments),
	appClientMeetings: many(appClientMeetings),
	appClientReferrals: many(appClientReferrals),
	appOpportunityProducts: many(appOpportunityProducts),
	...
	appClientCheckupPurposes: many(appClientCheckupPurposes),
	appClientConsultationCompanions: many(appClientConsultationCompanions),
	appClientConsultationNotes: many(appClientConsultationNotes),
	appClientInterestCategories: many(appClientInterestCategories),
	appClientMedicalHistories: many(appClientMedicalHistory),
...
export const appClientProfilesRelations = relations(appClientProfiles, ({one, many}) => ({
	appClientDocuments: many(appClientDocuments),
	appPipelineStageHistories: many(appPipelineStageHistory),
	appClientInsuranceContracts: many(appClientInsuranceContracts),
	appClientMeetings: many(appClientMeetings),
...
export const appClientInsuranceRelations = relations(appClientInsurance, ({one, many}) => ({
	appClientDocuments: many(appClientDocuments),
	appClientProfile: one(appClientProfiles, {
...
export const appPipelineAutomationsRelations = relations(appPipelineAutomations, ({one}) => ({
	appPipelineStage: one(appPipelineStages, {
...
export const appPipelineStagesRelations = relations(appPipelineStages, ({one, many}) => ({
	appPipelineAutomations: many(appPipelineAutomations),
	appPipelineGoals: many(appPipelineGoals),
...
export const appUserTeamsRelations = relations(appUserTeams, ({one, many}) => ({
	appPipelineAutomations: many(appPipelineAutomations),
	appPipelineGoals: many(appPipelineGoals),
	appPipelineStageTemplates: many(appPipelineStageTemplates),
	appPipelineViews: many(appPipelineViews),
...
export const appPipelineGoalsRelations = relations(appPipelineGoals, ({one}) => ({
	appPipelineStage: one(appPipelineStages, {
...
export const appPipelineStageHistoryRelations = relations(appPipelineStageHistory, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appPipelineStageTemplatesRelations = relations(appPipelineStageTemplates, ({one}) => ({
	appUserTeam: one(appUserTeams, {
...
export const appPipelineViewsRelations = relations(appPipelineViews, ({one}) => ({
	appUserTeam: one(appUserTeams, {
...
export const appClientInsuranceContractsRelations = relations(appClientInsuranceContracts, ({one, many}) => ({
	appUserProfile: one(appUserProfiles, {
		fields: [appClientInsuranceContracts.agentId],
		references: [appUserProfiles.id]
	}),
	appClientProfile: one(appClientProfiles, {
		fields: [appClientInsuranceContracts.clientId],
		references: [appClientProfiles.id]
	}),
	appOpportunityProduct: one(appOpportunityProducts, {
		fields: [appClientInsuranceContracts.opportunityProductId],
		references: [appOpportunityProducts.id]
	}),
	appClientContractAttachments: many(appClientContractAttachments),
}));

export const appOpportunityProductsRelations = relations(appOpportunityProducts, ({one, many}) => ({
	appClientInsuranceContracts: many(appClientInsuranceContracts),
	appUserProfile: one(appUserProfiles, {
		fields: [appOpportunityProducts.agentId],
		references: [appUserProfiles.id]
	}),
	appClientProfile: one(appClientProfiles, {
		fields: [appOpportunityProducts.clientId],
		references: [appClientProfiles.id]
	}),
}));

export const appClientContractAttachmentsRelations = relations(appClientContractAttachments, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
		fields: [appClientContractAttachments.agentId],
		references: [appUserProfiles.id]
	}),
	appClientInsuranceContract: one(appClientInsuranceContracts, {
		fields: [appClientContractAttachments.contractId],
		references: [appClientInsuranceContracts.id]
	}),
}));

export const appClientMeetingsRelations = relations(appClientMeetings, ({one, many}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appClientReferralsRelations = relations(appClientReferrals, ({one, many}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appClientDetailsRelations = relations(appClientDetails, ({one}) => ({
	appClientProfile: one(appClientProfiles, {
...
export const appCalendarMeetingAttendeesRelations = relations(appCalendarMeetingAttendees, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appCalendarMeetingChecklistsRelations = relations(appCalendarMeetingChecklists, ({one}) => ({
	appClientMeeting: one(appClientMeetings, {
...
export const appCalendarMeetingNotesRelations = relations(appCalendarMeetingNotes, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appCalendarMeetingRemindersRelations = relations(appCalendarMeetingReminders, ({one}) => ({
	appClientMeeting: one(appClientMeetings, {
...
export const appCalendarRecurringMeetingsRelations = relations(appCalendarRecurringMeetings, ({one}) => ({
	appClientMeeting: one(appClientMeetings, {
...
export const appCalendarSyncLogsRelations = relations(appCalendarSyncLogs, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appInfluencerGratitudeHistoryRelations = relations(appInfluencerGratitudeHistory, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appInfluencerProfilesRelations = relations(appInfluencerProfiles, ({one, many}) => ({
	appInfluencerGratitudeHistories: many(appInfluencerGratitudeHistory),
...
export const appUserInvitationsRelations = relations(appUserInvitations, ({one, many}) => ({
...
export const appClientAnalyticsRelations = relations(appClientAnalytics, ({one}) => ({
	appClientProfile: one(appClientProfiles, {
...
export const appClientContactHistoryRelations = relations(appClientContactHistory, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appClientDataAccessLogsRelations = relations(appClientDataAccessLogs, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appClientDataBackupsRelations = relations(appClientDataBackups, ({one}) => ({
	appClientProfile: one(appClientProfiles, {
...
export const appClientFamilyMembersRelations = relations(appClientFamilyMembers, ({one}) => ({
	appClientProfile: one(appClientProfiles, {
...
export const appClientMilestonesRelations = relations(appClientMilestones, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appClientPreferencesRelations = relations(appClientPreferences, ({one}) => ({
	appClientProfile: one(appClientProfiles, {
...
export const appClientStageHistoryRelations = relations(appClientStageHistory, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appClientTagAssignmentsRelations = relations(appClientTagAssignments, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appClientTagsRelations = relations(appClientTags, ({one, many}) => ({
	appClientTagAssignments: many(appClientTagAssignments),
	appUserProfile: one(appUserProfiles, {
...
export const appInvitationUsageLogsRelations = relations(appInvitationUsageLogs, ({one}) => ({
...
export const appNetworkNodesRelations = relations(appNetworkNodes, ({one, many}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appPipelineAnalyticsRelations = relations(appPipelineAnalytics, ({one}) => ({
	appPipelineStage: one(appPipelineStages, {
...
export const appClientCheckupPurposesRelations = relations(appClientCheckupPurposes, ({one}) => ({
	appClientProfile: one(appClientProfiles, {
...
export const appClientConsultationCompanionsRelations = relations(appClientConsultationCompanions, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appClientConsultationNotesRelations = relations(appClientConsultationNotes, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appClientInterestCategoriesRelations = relations(appClientInterestCategories, ({one}) => ({
	appClientProfile: one(appClientProfiles, {
...
export const appClientMedicalHistoryRelations = relations(appClientMedicalHistory, ({one}) => ({
	appClientProfile: one(appClientProfiles, {
...
export const appInfluencerActivityLogsRelations = relations(appInfluencerActivityLogs, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appNetworkEdgesRelations = relations(appNetworkEdges, ({one, many}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appNetworkOpportunitiesRelations = relations(appNetworkOpportunities, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appNetworkInteractionsRelations = relations(appNetworkInteractions, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const publicSiteAnnouncementsRelations = relations(publicSiteAnnouncements, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const publicSiteAnalyticsRelations = relations(publicSiteAnalytics, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const publicSiteContentsRelations = relations(publicSiteContents, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const publicSiteTestimonialsRelations = relations(publicSiteTestimonials, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appCalendarMeetingTemplatesRelations = relations(appCalendarMeetingTemplates, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appCalendarSettingsRelations = relations(appCalendarSettings, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appDashboardActivityLogsRelations = relations(appDashboardActivityLogs, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appDashboardGoalsRelations = relations(appDashboardGoals, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appDashboardNotificationsRelations = relations(appDashboardNotifications, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appDashboardPerformanceMetricsRelations = relations(appDashboardPerformanceMetrics, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appDashboardQuickActionsRelations = relations(appDashboardQuickActions, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appDashboardWidgetsRelations = relations(appDashboardWidgets, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appInfluencerGratitudeTemplatesRelations = relations(appInfluencerGratitudeTemplates, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appInfluencerNetworkAnalysisRelations = relations(appInfluencerNetworkAnalysis, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appNetworkStatsRelations = relations(appNetworkStats, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appNotificationHistoryRelations = relations(appNotificationHistory, ({one}) => ({
...
export const appNotificationQueueRelations = relations(appNotificationQueue, ({one, many}) => ({
	appNotificationHistories: many(appNotificationHistory),
...
export const appNotificationTemplatesRelations = relations(appNotificationTemplates, ({one, many}) => ({
	appNotificationQueues: many(appNotificationQueue),
	appUserTeam: one(appUserTeams, {
...
export const appNotificationRulesRelations = relations(appNotificationRules, ({one}) => ({
	appUserTeam: one(appUserTeams, {
...
export const appNotificationSettingsRelations = relations(appNotificationSettings, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appNotificationSubscriptionsRelations = relations(appNotificationSubscriptions, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appReportDashboardsRelations = relations(appReportDashboards, ({one}) => ({
	appUserTeam: one(appUserTeams, {
...
export const appReportExportsRelations = relations(appReportExports, ({one}) => ({
...
export const appReportInstancesRelations = relations(appReportInstances, ({one, many}) => ({
	appReportExports: many(appReportExports),
...
export const appReportSchedulesRelations = relations(appReportSchedules, ({one, many}) => ({
	appReportInstances: many(appReportInstances),
	appUserTeam: one(appUserTeams, {
...
export const appReportTemplatesRelations = relations(appReportTemplates, ({one, many}) => ({
	appReportInstances: many(appReportInstances),
	appReportSchedules: many(appReportSchedules),
	appReportSubscriptions: many(appReportSubscriptions),
	appUserTeam: one(appUserTeams, {
...
export const appReportMetricsRelations = relations(appReportMetrics, ({one}) => ({
	appUserTeam: one(appUserTeams, {
...
export const appReportSubscriptionsRelations = relations(appReportSubscriptions, ({one}) => ({
	appReportTemplate: one(appReportTemplates, {
...
export const appSettingsBackupsRelations = relations(appSettingsBackups, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appSettingsChangeLogsRelations = relations(appSettingsChangeLogs, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appSettingsIntegrationsRelations = relations(appSettingsIntegrations, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appSettingsSecurityLogsRelations = relations(appSettingsSecurityLogs, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appSettingsThemePreferencesRelations = relations(appSettingsThemePreferences, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appSettingsUserProfilesRelations = relations(appSettingsUserProfiles, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appTeamActivityLogsRelations = relations(appTeamActivityLogs, ({one}) => ({
	appUserTeam: one(appUserTeams, {
...
export const appTeamCommunicationChannelsRelations = relations(appTeamCommunicationChannels, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appTeamPerformanceMetricsRelations = relations(appTeamPerformanceMetrics, ({one}) => ({
	appUserProfile: one(appUserProfiles, {
...
export const appTeamStatsCacheRelations = relations(appTeamStatsCache, ({one}) => ({
	appUserTeam: one(appUserTeams, {
...
export const appTeamTrainingRecordsRelations = relations(appTeamTrainingRecords, ({one}) => ({
