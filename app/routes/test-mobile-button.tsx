...
export function meta() {
  return [
    ...
    { name: "description", content: "모바일 최적화된 Button 컴포넌트 테스트 페이지" }
  ];
}
...
export default function TestMobileButtonPage({ loaderData }: { loaderData: { message: string } }) {
  return (
    <div className="container mx-auto p-8 space-y-8">
      ...
      <div className="bg-gray-100 p-6 rounded-lg">
        <h2 className="text-xl font-semibold mb-4">기본 Button vs ResponsiveButton</h2>
        ...
        <div className="space-y-4">
          ...
          <div>
            <h3 className="text-lg font-medium mb-2">ResponsiveButton (자동 감지)</h3>
            <div className="flex flex-wrap gap-2">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex flex-wrap gap-2 items-center">
              <ResponsiveButton forceVariant="desktop" size="sm">Small</ResponsiveButton>
              <ResponsiveButton forceVariant="desktop" size="default">Default</ResponsiveButton>
              <ResponsiveButton forceVariant="desktop" size="lg">Large</ResponsiveButton>
              <ResponsiveButton forceVariant="desktop" size="icon">🏠</ResponsiveButton>
            </div>
          </div>

          <div>
            <h3 className="text-lg font-medium mb-2">모바일 크기 (터치 최적화)</h3>
            <div className="flex flex-wrap gap-2 items-center">
              <ResponsiveButton 
                forceVariant="mobile" 
                mobileOnly={{ size: "sm" }}
      ...
      <div className="bg-gray-100 p-6 rounded-lg">
        ...
        <div className="text-sm text-gray-600">
          <p>화면 크기를 조절해보세요. ResponsiveButton이 자동으로 적절한 버전을 선택합니다.</p>
          <p className="mt-2">
            • 768px 미만: 모바일 버전 (터치 최적화, 큰 크기, 강한 피드백)
          </p>
          <p>
            • 768px 이상: 데스크톱 버전 (기본 ShadCN Button)
          </p>
        </div>
      </div>
    </div>
