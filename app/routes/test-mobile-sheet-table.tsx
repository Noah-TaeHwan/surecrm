...
export function meta() {
  return [
    ...
    {
      name: 'description',
      content: 'Testing mobile-optimized sheet and table components',
    },
  ];
}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            },
            {
              icon: TrendingUp,
              label: '활성 고객',
              value: filteredClients.filter(c => c.status === '활성').length,
              color: 'green',
            },
            {
              icon: DollarSign,
              ...
              value: formatCurrency(
                Math.round(
                  filteredClients.reduce((sum, c) => sum + c.premium, 0) /
            ...
            },
            {
              ...
              label: '평균 평점',
              value: (
                filteredClients.reduce((sum, c) => sum + c.rating, 0) /
                filteredClients.length
              ).toFixed(1),
              color: 'yellow',
            },
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  onClick={() => {
                    ...
                    addToLog(
                      `이름순 정렬 (${sortDirection === 'asc' ? '내림차순' : '오름차순'})`
                    );
                  }}
                >
          ...
          >
            ...
            <ResponsiveTableBody>
              {filteredClients.map((client, index) => (
                ...
                >
                  <ResponsiveTableCell mobileLabel="이름" mobilePrimary={true}>
