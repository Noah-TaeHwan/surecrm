...
export function meta() {
  return [
    ...
    {
      name: 'description',
      content: '모바일 디바이스에서 모달 내 input 포커스 시 줌인 방지 테스트',
    },
  ];
}
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            모바일/태블릿에서 모달 내 input 포커스 시 줌인이 발생하지 않는지
            테스트합니다.
          </p>
        </div>
        ...
        <div className="bg-blue-50 p-6 rounded-lg">
          <h2 className="font-semibold text-blue-900 mb-3">테스트 방법</h2>
          <ul className="text-blue-800 space-y-2 text-sm">
            <li>
              • 모바일 디바이스(iPhone, iPad, Android)에서 이 페이지를
              열어주세요
            </li>
          ...
          <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>
                  아래 각 input 필드를 터치해서 줌인이 발생하지 않는지
                  확인하세요.
                </DialogDescription>
              </DialogHeader>
        ...
        <div className="bg-green-50 p-6 rounded-lg">
          <h3 className="font-semibold text-green-900 mb-3">확인 사항</h3>
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          <h3 className="font-semibold text-gray-900 mb-3">적용된 해결책</h3>
          <ul className="text-gray-700 space-y-2 text-sm">
            <li>
              • Input, Select, Textarea 컴포넌트에{' '}
            ...
            <li>
              • CSS에서 모달 내 모든 입력 요소에 16px 이상 폰트 사이즈 강제 적용
            </li>
            <li>
              •{' '}
              <code className="bg-gray-200 px-1 rounded">
            ...
            <li>
              • Tailwind CSS의{' '}
              <code className="bg-gray-200 px-1 rounded">sm:text-sm</code>{' '}
              클래스를 모바일에서 무력화
            </li>
          </ul>
        </div>
