...
export function meta() {
  return [
    ...
    {
      name: 'description',
      content: 'SureCRM 반응형 레이아웃 컴포넌트들의 테스트 페이지입니다.',
    },
  ];
}
...
export default function TestResponsive() {
  const [accessibilityResults, setAccessibilityResults] = useState<
    Record<string, AccessibilityValidationResult>
  >({});
  ...
  useEffect(() => {
    if (containerRef.current) {
      const testSections = containerRef.current.querySelectorAll(
        '[data-test-section]'
      );
      ...
      testSections.forEach(section => {
        const sectionName =
          section.getAttribute('data-test-section') || 'unknown';
  ...
  // 접근성 배지 색상 결정
  const getAccessibilityBadgeVariant = (
    score: number
      ...
      <ResponsiveContainer size="2xl" padding="xl">
        ...
        >
          ...
          <p className="text-gray-600 mb-4">
            SureCRM의 반응형 레이아웃 컴포넌트들과 접근성 검증 기능을
            테스트합니다.
          </p>

          {/* 접근성 검증 결과 요약 */}
          <ResponsiveFlex wrap="wrap" gap="sm" className="mt-4">
            {Object.entries(accessibilityResults).map(
              ([sectionName, result]) => {
        ...
        >
          <h2 id="container-title" className="text-2xl font-semibold mb-4">
        ...
        >
          <h2 id="grid-title" className="text-2xl font-semibold mb-4">
            2. ResponsiveGrid
          </h2>
        ...
        >
          <h2 id="stack-title" className="text-2xl font-semibold mb-4">
            3. ResponsiveStack
          </h2>
        ...
        >
          <h2 id="flex-title" className="text-2xl font-semibold mb-4">
            4. ResponsiveFlex
          </h2>
          ...
          <ResponsiveStack gap="lg">
            ...
            <div>
              ...
              <ResponsiveFlex
                ...
                className="p-4 bg-gray-50 rounded"
                role="group"
                aria-label="Grow/Shrink 테스트 예시"
              >
                <div className="bg-blue-100 p-2 rounded flex-shrink-0">
                  고정 너비
                </div>
                <div className="bg-green-100 p-2 rounded flex-grow">
                  확장 가능
                </div>
        ...
        >
          <h2 id="section-title" className="text-2xl font-semibold mb-4">
            5. ResponsiveSection
          </h2>
          ...
          <ResponsiveStack gap="xl">
            ...
            <div>
              ...
              >
                <h4 id="article-title" className="font-semibold mb-2">
                  기사 제목
                </h4>
        ...
        >
          <h2 id="accessibility-title" className="text-2xl font-semibold mb-4">
            6. 접근성 검증 결과
          </h2>
        ...
        >
          ...
          <p className="text-gray-600 mb-4">
            Tab 키를 사용하여 아래 요소들을 순서대로 탐색해보세요.
          </p>
          ...
          <ResponsiveFlex direction="row" wrap="wrap" gap="md">
            ...
            <span id="button1-desc" className="sr-only">
              첫 번째 테스트 버튼입니다
            </span>
            ...
            <span id="button2-desc" className="sr-only">
              두 번째 테스트 버튼입니다
            </span>
            ...
            <span id="button3-desc" className="sr-only">
              페이지의 첫 번째 포커스 가능한 요소로 이동합니다
            </span>
          </ResponsiveFlex>
        </ResponsiveSection>
      </ResponsiveContainer>
