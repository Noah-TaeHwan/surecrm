  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'relative z-50 max-h-96 min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-md border-2 border-gray-300 dark:border-gray-600 bg-popover text-popover-foreground shadow-lg scrollbar-none',
