  ...
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        ...
        className={cn(
          'z-50 min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-md border border-gray-200 dark:border-gray-700 bg-popover text-popover-foreground p-1 shadow-md scrollbar-none',
