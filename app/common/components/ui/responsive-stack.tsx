  ...
  (
    ...
    const getResponsiveClasses = () => {
      ...
      if (sm) {
        ...
        if (sm.wrap !== undefined)
          classes.push(sm.wrap ? 'sm:flex-wrap' : 'sm:flex-nowrap');
      }
      ...
      if (md) {
        ...
        if (md.wrap !== undefined)
          classes.push(md.wrap ? 'md:flex-wrap' : 'md:flex-nowrap');
      }
      ...
      if (lg) {
        ...
        if (lg.wrap !== undefined)
          classes.push(lg.wrap ? 'lg:flex-wrap' : 'lg:flex-nowrap');
      }
      ...
      if (xl) {
        ...
        if (xl.wrap !== undefined)
          classes.push(xl.wrap ? 'xl:flex-wrap' : 'xl:flex-nowrap');
      }

      if (xl2) {
        if (xl2.direction)
          classes.push(`2xl:${directionClasses[xl2.direction]}`);
        ...
        if (xl2.wrap !== undefined)
          classes.push(xl2.wrap ? '2xl:flex-wrap' : '2xl:flex-nowrap');
      }
