...
export function Header({
  ...
  return (
    <header
      className={cn(
        'fixed top-0 left-0 right-0 z-50 h-14 md:h-16 px-4 md:px-6 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 flex items-center justify-between',
        className
      )}
    >
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              {unreadCount > 0 && (
                <div className="absolute -top-0.5 -right-0.5 w-5 h-5 bg-primary text-primary-foreground text-xs rounded-full flex items-center justify-center">
