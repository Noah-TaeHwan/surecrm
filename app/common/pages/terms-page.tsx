        ...
        <Tabs defaultValue="terms">
          ...
          <CardContent>
            <TabsContent value="terms" className="mt-0">
              ...
              <div className="prose max-w-none">
                ...
                <p>
                  ...
                  있으며, 변경된 약관은 제1항과 같은 방법으로 공지함으로써
                  효력이 발생합니다.
                </p>
                ...
                <p>
                  ② 회사는 서비스를 일정범위로 분할하여 각 범위별로
                  이용가능시간을 별도로 지정할 수 있습니다.
                </p>
                ...
                <p>
                  ...
                  일시적으로 중단할 수 있습니다.
                  <br />② 제1항에 의한 서비스 중단의 경우에는 회사는 제8조에
                  정한 방법으로 이용자에게 통지합니다. 다만, 회사가 사전에
            ...
            <TabsContent value="privacy" className="mt-0">
              <CardTitle className="mb-4">개인정보처리방침</CardTitle>
              <div className="prose max-w-none">
                <h2>개인정보처리방침</h2>
                <p>
                  SureCRM(이하 '회사'라 함)은 개인정보보호법, 정보통신망
                  이용촉진 및 정보보호 등에 관한 법률 등 관련 법령에 따라
                ...
                <ol>
                  ...
                  <li>
                    ...
                    개인식별, 불량회원의 부정이용 방지와 비인가 사용방지,
                    가입의사 확인, 가입 및 가입횟수 제한, 분쟁 조정을 위한
                    기록보존, 불만처리 등 민원처리, 고지사항 전달 등을 목적으로
                    개인정보를 처리합니다.
                  </li>
                </ol>
