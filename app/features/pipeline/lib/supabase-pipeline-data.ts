              ...
              const interestMap = [
                {
                  ...
                  label: 'interests.autoInsurance',
                  icon: '🚗',
                },
                {
                  key: 'interestedInDementia',
                  label: 'interests.dementia',
                  icon: '🧠',
                },
                {
                  key: 'interestedInDental',
                  label: 'interests.dental',
                  icon: '🦷',
                },
                {
                  key: 'interestedInDriverInsurance',
                  label: 'interests.driverInsurance',
                  icon: '🚙',
                },
                {
                  key: 'interestedInHealthCheckup',
                  label: 'interests.healthCheckup',
                  icon: '🏥',
                },
                {
                  key: 'interestedInMedicalExpenses',
                  label: 'interests.medicalExpenses',
                  icon: '💊',
                },
                {
                  key: 'interestedInFireInsurance',
                  label: 'interests.fireInsurance',
                  icon: '🔥',
                },
                {
                  key: 'interestedInCaregiver',
                  label: 'interests.caregiver',
                  icon: '👩‍⚕️',
                },
                {
                  key: 'interestedInCancer',
                  label: 'interests.cancer',
                  icon: '🎗️',
                },
                {
                  key: 'interestedInSavings',
                  label: 'interests.savings',
                  icon: '💰',
                },
                {
                  key: 'interestedInLiability',
                  label: 'interests.liability',
                  icon: '⚖️',
                },
                {
                  key: 'interestedInLegalAdvice',
                  label: 'interests.legalAdvice',
                  icon: '⚖️',
                },
                { key: 'interestedInTax', label: 'interests.tax', icon: '📋' },
                {
                  key: 'interestedInInvestment',
                  label: 'interests.investment',
                  icon: '📈',
                },
                {
                  key: 'interestedInPetInsurance',
                  label: 'interests.petInsurance',
                  icon: '🐕',
                },
                {
                  key: 'interestedInAccidentInsurance',
                  label: 'interests.accidentInsurance',
                  icon: '🩹',
                },
                {
                  key: 'interestedInTrafficAccident',
                  label: 'interests.trafficAccident',
                  icon: '🚨',
                },
              ];
