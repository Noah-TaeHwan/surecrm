...
export function RemoveClientModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-xl w-[95vw] p-0 overflow-hidden flex flex-col sm:max-h-[85vh] gap-0">
        ...
        <DialogFooter className="p-6 pt-4 gap-2 sm:gap-3">
          <Button 
            variant="outline" 
            onClick={onClose} 
            disabled={isLoading}
          ...
          <Button
            ...
            disabled={isLoading}
            className="flex-1 sm:flex-none gap-2 bg-orange-100 hover:bg-orange-200 text-orange-800 border-orange-300"
          >
            {isLoading ? (
              <>
